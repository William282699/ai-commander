...
//
// ★ 一处已刷新：`attack`（approval-contract-v4 刀F, 2026-08-05，提案 §1-F）。
//   本快照钉的是"默认行为不许漂"，而 attack 的目的地正是刀F 要改的东西——
//   它不是漂移，是本刀的合同本身，所以只刷这一条，另外四条逐字未动。
//   旧值 (239,76)±spread = 山脊战线【几何中心】；新值 (230,70)±spread =
//   中央山脊，该线上敌方的胜负点。手测实证：挂在 approach 档上时，
//   「拿下山脊战线」把突击队送去了我方自己那场遭遇战（离 VP 36 格）。
//   旧几何中心离该 VP 只有 10.8 格是本线几何巧合（两个 VP 恰好夹住质心），
//   不是它算对了——换一条线（中央战线）同样的巧合就不成立。
//
// ★ 二处已刷新：`defend` / `recon` / `patrol` 三条，y 76 → 75
//   （envelope-precision 刀3，R12，2026-08-07，Fable 裁定后刷新）。
//   因果链（单因可归，算术已双方复算）：
//     R12 为了救 5 行缝里那辆开局敌军主战坦克 #153 (252,82)，把 ruweisat_zone
//     北缘 85 → 81 ⇒ 该矩形中心 y 100 → 98 ⇒ front_ridge 的 frontCenterPos
//     y = (60 + 67.5 + 100)/3 = 75.83 → (60 + 67.5 + 98)/3 = 75.17 ⇒ 取整 76 → 75。
//   为什么只漂这三条：本 fixture 的目标战线上既无友军也无我方设施，defend/recon/
//   patrol 三个动词一路走到**最后一档 frontCenterPos**，中心一动它们就动；
//   `attack` 走敌方 VP 档、`retreat` 走我方设施档，够不到最后一档，
//   因此**逐字节未动**（复跑实证，不是推断）。
//   规矩（本次立）：快照只在「单因可归 + 主审签字」时刷；
//   实施者自己"按预期"去刷是禁止的——真漂了先停手上报。
const EXPECTED: Record<string, string> = {
  ...
  "attack": "[{\"u\":[9000],\"a\":\"attack_move\",\"t\":{\"x\":231.5,\"y\":70}},{\"u\":[9001],\"a\":\"attack_move\",\"t\":{\"x\":230,\"y\":71.5}},{\"u\":[9002],\"a\":\"attack_move\",\"t\":{\"x\":228.5,\"y\":70}},{\"u\":[9003],\"a\":\"attack_move\",\"t\":{\"x\":230,\"y\":68.5}}]",
  "defend": "[{\"u\":[9000],\"a\":\"defend\",\"t\":{\"x\":240,\"y\":75}},{\"u\":[9001],\"a\":\"defend\",\"t\":{\"x\":239,\"y\":76}},{\"u\":[9002],\"a\":\"defend\",\"t\":{\"x\":238,\"y\":75}},{\"u\":[9003],\"a\":\"defend\",\"t\":{\"x\":239,\"y\":74}}]",
  "recon": "[{\"u\":[9000],\"a\":\"recon\",\"t\":{\"x\":239,\"y\":75}},{\"u\":[9001],\"a\":\"recon\",\"t\":{\"x\":239,\"y\":75}},{\"u\":[9002],\"a\":\"recon\",\"t\":{\"x\":239,\"y\":75}},{\"u\":[9003],\"a\":\"recon\",\"t\":{\"x\":239,\"y\":75}}]",
  "patrol": "[{\"u\":[9000],\"a\":\"patrol\",\"t\":{\"x\":239,\"y\":75}},{\"u\":[9001],\"a\":\"patrol\",\"t\":{\"x\":239,\"y\":75}},{\"u\":[9002],\"a\":\"patrol\",\"t\":{\"x\":239,\"y\":75}},{\"u\":[9003],\"a\":\"patrol\",\"t\":{\"x\":239,\"y\":75}}]",
};
