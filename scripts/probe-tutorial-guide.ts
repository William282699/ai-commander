...
check("行军类步骤给了更长的等待", GUIDE_STEPS[6].nudgeAfterSec === NUDGE_AFTER_SEC_SLOW
  && GUIDE_STEPS[7].nudgeAfterSec === NUDGE_AFTER_SEC_SLOW,
  `烽火台 ${GUIDE_STEPS[6].nudgeAfterSec}s / 哨站 ${GUIDE_STEPS[7].nudgeAfterSec}s`);
