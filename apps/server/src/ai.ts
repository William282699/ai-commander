...
【本次强制】指挥官这一句走的是语音。你返回的 JSON【必须】含根级 "heard" 字段＝你听到的那句话的**逐字转写**。没听清的那几个字就照你听到的音写下来、或直说没听清——**不要把话顺通顺，也不要拿信封里现成的名字去补你没听清的音**：引擎把 heard 当长官的原话用（回填他的气泡、判断他点没点名部队），顺过一次，引擎就会替他做一个他没做的决定。转写只进 heard 字段，正文里不要复述它——正文写的是你要对长官说的话，不是他刚说过的那句。缺失该字段视为无效输出。
